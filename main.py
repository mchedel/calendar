...
def show_countdown():
    ...
    def open_add_event_window():
        ...
        event_name_entry.grid(row=0,column=0,padx=10,pady=5)
        event_date_entry.grid(row=1,column=0,padx=10,pady=5)
        ...
        def add_event():
            ...
            try:
                ...
                messagebox.showinfo("Error", "Date format must be in dd/mm/yy")
